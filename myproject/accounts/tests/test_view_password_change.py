...
class PasswordChangeTests(TestCase):
    def setUp(self):
        username = 'orlando1080'
        password = 'finishingtouch7'
        user = User.objects.create_user(username=username, email='orlando1080@gmail.com', password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    def setUp(self, data={}):
        self.user = User.objects.create_user(username='orlando1080', email='orlando1080@gmail.com', password='old_password')
        self.url = reverse('password_change')
        self.client.login(username='orlando1080', password='old_password')
...
class SuccessfulPasswordChangeTests(PasswordChangeTestCase):
    ...
    def test_user_autentication(self):
